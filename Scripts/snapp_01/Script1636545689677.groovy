...
Mobile.tap(findTestObject('Object Repository/android.widget.TextView - DESHBANDHU DBK Black Jute Nehru Jacket Single Pack'), 
    0)

Mobile.tap(findTestObject('Object Repository/android.widget.ImageView (11)'), 0)

Mobile.tap(findTestObject('Object Repository/android.widget.TextView - 40 (1)'), 0)

Mobile.tap(findTestObject('Object Repository/android.widget.TextView - Add to Cart (12)'), 0)
