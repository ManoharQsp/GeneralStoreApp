...
Mobile.scrollToText('Zimbabwe')

Mobile.tap(findTestObject('Object Repository/android.widget.TextView - Zimbabwe'), 0)

Mobile.tap(findTestObject('Object Repository/android.widget.EditText - Enter name here'), 0)

Mobile.setText(findTestObject('Object Repository/android.widget.EditText - Enter name here (1)'), 'Manohar', 0)
...
Mobile.scrollToText('Visit to the website to complete purchase')
