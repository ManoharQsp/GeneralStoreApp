...
Mobile.tap(findTestObject('Object Repository/android.webkit.WebView (5)'), 0)

Mobile.tap(findTestObject('Object Repository/android.widget.Button - SKIP (3)'), 0)

Mobile.tap(findTestObject('Object Repository/android.widget.Button - Select Location Manually (1)'), 0)

Mobile.setText(findTestObject('Object Repository/android.widget.EditText (1)'), 'wa', 0)
...
Mobile.tap(findTestObject('Object Repository/android.widget.Button - search'), 0)
