...
Mobile.tap(findTestObject('Object Repository/android.webkit.WebView (6)'), 0)

Mobile.tap(findTestObject('Object Repository/android.widget.Button - SKIP (5)'), 0)

Mobile.tap(findTestObject('Object Repository/android.widget.Button - Select Location Manually (3)'), 0)

Mobile.setText(findTestObject('Object Repository/android.widget.EditText (3)'), 'wa', 0)
