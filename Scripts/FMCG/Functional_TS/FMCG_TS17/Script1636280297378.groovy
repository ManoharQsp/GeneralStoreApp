...
Mobile.tap(findTestObject('Object Repository/android.webkit.WebView (12)'), 0)

Mobile.tap(findTestObject('Object Repository/android.widget.Button - SKIP (13)'), 0)

Mobile.tap(findTestObject('Object Repository/android.widget.Button - Select Location Manually (10)'), 0)
