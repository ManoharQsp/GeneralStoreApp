...
<MobileElementEntity>
   ...
   <name>android.widget.Button - Start Shopping</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.Button' and (@text = 'Start Shopping' or . = 'Start Shopping')]</locator>
